...
const constants_2 = require("../vehicle/constants");
...
const getBookings = (_a, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (searchTerm) {
        pipeline.push({
            OR: constants_1.bookingSearchableFields.map(field => ({
    ...
    if (Object.keys(filterData).length > 0) {
        pipeline.push({
            AND: Object.keys(filterData).map(key => {
                if (constants_1.bookingRelationalFields.includes(key)) {
                    return {
                        [constants_2.vehicleRelationalFieldsMapper[key]]: {
                            id: filterData[key],
                        },
                    };
                }
...
const deleteBooking = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!booking)
        throw new ApiError_1.default(400, 'Failed to created booking!');
    return booking;
});
