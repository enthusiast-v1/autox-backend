...
const createDriver = (_a) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield prisma_1.default.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        result = Object.assign(Object.assign(Object.assign({}, user), driver), profile);
    }));
    if (!result)
...
const availableDrivers = (date) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const bookedDriverIds = (yield prisma_1.default.booking.findMany({
        where: {
            pickUpDateTime: date,
        },
        select: {
    ...
    const availableDrivers = yield prisma_1.default.driver.findMany({
        where: {
            id: {
