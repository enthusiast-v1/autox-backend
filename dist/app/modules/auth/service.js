...
const login = ({ email, password }) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const user = yield prisma_1.default.user.findUnique({ where: { email } });
    if (!user) throw new ApiError_1.default(404, "User doesn't exist!");
    const isPasswordMatched = yield (0, bcrypt_1.matchPassword)(
      password,
      user.password,
    );
    if (!isPasswordMatched)
...
const register = _a =>
  __awaiter(void 0, void 0, void 0, function* () {
    var { email, password } = _a,
      others = __rest(_a, ['email', 'password']);
    ...
    yield prisma_1.default.$transaction(tx =>
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        profile = yield tx.profile.create({
          data: Object.assign({ userId: user.id }, others),
        });
      }),
    );
    if (!profile || !user)
